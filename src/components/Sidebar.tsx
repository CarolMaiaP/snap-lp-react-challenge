...
export function Sidebar({active}:sidebarProps){
  ...
  return(
    <div sidebar={active} className="menu-mobile">
        <div className="menu-content" id="mob-menu">
        <div className="btn-close">
          <a href="#" onClick={handleCloseMenu}>&#9747;</a>
        </div>
          <div className="menu-contain">
            <ul>
              <li><a href="#">Features</a><svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
              <div className="submenu sub-features">
                <ul>
              ...
              <li><a href="#">Company</a><svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
              <div className="submenu sub-company">
                <ul>
